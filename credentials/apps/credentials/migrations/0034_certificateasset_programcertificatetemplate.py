# Generated by Django 5.2.7 on 2026-03-31 04:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created'],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_active', True)), fields=('program_certificate', 'organization'), name='unique_active_template_per_program_org', nulls_distinct=False)],
            },
        ),
    ]
