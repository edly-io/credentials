...
def dynamic_theming_context(request):  # pylint: disable=unused-argument
    ...
    """
    configuration_helpers = request.site.siteconfiguration.edly_client_branding_and_django_settings
...
def edly_app_context(request):  # pylint: disable=unused-argument
    ...
    edly_context.update(
        {
            'session_cookie_domain': site_configuration.get_edly_configuration_value(
