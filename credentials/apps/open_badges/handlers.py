...
from credentials.apps.open_badges.issuers import OpenBadgeTemplateIssuer
...
def handle_badge_completion(sender, username, badge_template_id, **kwargs):  # pylint: disable=unused-argument
    ...
    OpenBadgeTemplateIssuer().award(username=username, credential_id=badge_template_id)
...
def handle_badge_regression(sender, username, badge_template_id, **kwargs):  # pylint: disable=unused-argument
    ...
    OpenBadgeTemplateIssuer().revoke(badge_template_id, username)